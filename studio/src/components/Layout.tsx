  ...
  const adminNavGroups: AdminNavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/admin/news', icon: Newspaper, label: t('admin.news.title', '最新消息') },
        { path: '/admin/course-intro', icon: BookOpen, label: t('admin.courseIntro.title', '課堂介紹') },
        { path: '/admin/settings', icon: Info, label: t('nav.settingsHomeAbout', '關於我們') },
        { path: '/admin/contact', icon: Phone, label: t('admin.contact.title', '聯絡我們') },
        { path: '/admin/faq', icon: HelpCircle, label: t('admin.faq.heading', '常見問題') },
        { path: '/admin/terms', icon: ScrollText, label: t('admin.terms.heading', '條款細則') },
