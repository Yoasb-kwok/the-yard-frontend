...
export function buildSeed(): DemoDb {
  ...
  const profiles: DemoDb['profiles'] = [
    {
      id: 'prof_002_parent',
      user_id: 'user_002',
      profile_kind: 'parent',
  ...
  const notifications: DemoDb['notifications'] = [
    {
      ...
      body: '',
      type: 'class_change',
      titleKey: 'classChangeTitle',
      messageKey: 'classChangeMessage',
      className: '兒童芭蕾啟蒙班',
      dateTimeStr: '下週一 16:00（新蒲崗）',
      studentName: '陳小美',
      is_read: false,
    ...
    },
    {
      ...
      body: '',
      type: 'leave_approved',
      titleKey: 'leaveApprovedTitle',
      messageKey: 'leaveApprovedMessage',
      className: '兒童芭蕾啟蒙班',
      studentName: '陳小美',
      is_read: false,
      created_at: iso(daysFromNow(-1)),
