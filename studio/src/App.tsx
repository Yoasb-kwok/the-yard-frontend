...
import AdminTrialApplicationCreatePage from './pages/admin/AdminTrialApplicationCreatePage';
    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          />
          <Route
            path="/admin/trial-applications/new"
            element={
              <ProtectedRoute requireAdmin>
                <AdminTrialApplicationCreatePage />
              </ProtectedRoute>
            }
          />
          <Route
