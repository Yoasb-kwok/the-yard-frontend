...
| | | | | | | | |
| createClassEnrollment | Calendar, Schedule | POST | /api/class-enrollments | {<br>    "class_id": 1,<br>    "user_token_id": 1<br>} | {<br>    "success": true,<br>    "data": {}<br>} | {<br>    "success": false,<br>    "msg": "..."<br>} | Enroll in class; deducts from user_token |
| | | | | | | | |
...
| | | | | | | | |
| getUsers | Users | GET | /api/admin/users | {<br>    "search": "張"<br>} | {<br>    "success": true,<br>    "data": [<br>        {<br>            "id": 1,<br>            "full_name": "...",<br>            "role": "student",<br>            "mobile": "...",<br>            "created_at": "...",<br>            "user_tokens": []<br>        }<br>    ]<br>} | {<br>    "success": false,<br>    "msg": "..."<br>} | Query. Excludes admin/instructor. Rows are login accounts (typically parent master); student profiles may live as sub-accounts under the master in the product model. |
| | | | | | | | |
| updateUser | Users | PATCH | /api/admin/users/:id | {<br>    "full_name": "...",<br>    "mobile": "...",<br>    "role": "student"<br>} | {<br>    "success": true,<br>    "data": {}<br>} | {<br>    "success": false,<br>    "msg": "..."<br>} | — |
| | | | | | | | |
...
| | | | | | | | |
| getInstructors | Instructors | GET | /api/admin/instructors | — | {<br>    "success": true,<br>    "data": [<br>        {<br>            "id": 1,<br>            "name": "...",<br>            "profile_image_url": "...",<br>            "created_at": "..."<br>        }<br>    ]<br>} | {<br>    "success": false,<br>    "msg": "..."<br>} | — |
| | | | | | | | |
